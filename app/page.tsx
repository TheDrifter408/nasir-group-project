...
export default function Home() {
  ...
  return (
    <Content> 
        <CTA />
        <section className="grid items-start px-4 gap-6 lg:grid-cols-2 mt-20">
        ...
        <section className="grid gap-6 my-10">
          <article className="h-min grid lg:grid-cols-2">
            ...
            <div className="sm:hidden lg:block lg:col-start-1 row-start-1 overflow-hidden">
